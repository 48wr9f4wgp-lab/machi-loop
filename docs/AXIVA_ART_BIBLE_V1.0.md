# AXIVA — ART BIBLE v1.0

Status: LOCKED — title-local Canonical / Visual North Star
Date: 2026-09-17 JST
Scope: Vertical Slice v2 onward
Authority: Title-local Art Bible / Visual Canonical for AXIVA.
Scope: title-local
Version: 1.0
Locked by user: 2026-09-17 JST
Official title rename: AXIVA（アクシヴァ） — LOCKED 2026-09-18 JST
...
- canonical asset label: `AXIVA_Visual_North_Star_v1_MASTER.png`
- legacy source filename / alias: `MACHI_LOOP_Visual_North_Star_v1_MASTER.png`
...
- canonical preview label: `AXIVA_Visual_North_Star_v1.jpg`
- legacy preview filename / alias: `MACHI_LOOP_Visual_North_Star_v1.jpg` / Drive file id `1BXDJzaV9ICRx9KCTw7wVaZ0gvpseU1TU`
- legacy repo-preview reference: `docs/visual/MACHI_LOOP_Visual_North_Star_v1.jpg` (retain as migration alias until an AXIVA-named preview is actually added)
...
1. このArt BibleをAXIVAのtitle-local Canonical / Visual Canonicalとして維持。
