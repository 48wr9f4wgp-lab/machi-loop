...
if grep -E 'SCRIPT ERROR|Parse Error|Failed to load script|V42_MAIN_PLAY_LOOP_FAILED' playable-loop.log; then
    exit 1
fi
grep -q 'V42_MAIN_PLAY_LOOP_OK' playable-loop.log
