...
required = set()
for name in ('main_v40_land_acquisition.gd', 'main_v41_camera_navigation.gd', 'main_v42_playable_loop.gd', 'main_v43_tempo_payoff.gd', 'main_v44_core_fun.gd', 'main_zero_core_fun.gd'):
